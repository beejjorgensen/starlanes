...
1190 PRINTM$(T1);"!":PRINT"PLEASE NOT THE FOLLOWING TRANSACTIONS."
...
1320 Q(T1)=Q(T1)+Q(X):S1(T1)=S1(T1)+S1(X):IFS1(T1)>3000THENGOSUB14000
...
1470 PRINTM$(13);TAB(30)S1(I3);TAB(50)S(I3,P)
1480 NEXTI3:RETURN
...
8520 PRINT"SMALLER COMPANY IS EXCHANGED FOR SHARED IN THE LARGER"
